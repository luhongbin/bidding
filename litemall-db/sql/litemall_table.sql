...
CREATE TABLE `litemall_storage` (
                                    ...
                                    `type` varchar(120) NOT NULL COMMENT '文件类型',
...
DROP TABLE IF EXISTS `litemall_teu`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `litemall_teu` (
                                `id` int(11) NOT NULL AUTO_INCREMENT,
                                `user_id` int(11) NOT NULL COMMENT '用户id',
                                `username` varchar(63) NOT NULL COMMENT '用户名称',
                                `teu_type_cn` varchar(20) NOT NULL COMMENT 'TEU中文类型',
                                `teu_type_en` varchar(20) NOT NULL COMMENT 'TEU英文类型',
                                `teu_name_cn` varchar(63) NOT NULL COMMENT 'TEU中文名称',
                                `teu_name_en` varchar(63) NOT NULL COMMENT 'TEU英文名称',
                                `length` decimal(10,2) NOT NULL DEFAULT '0' COMMENT '长(米)',
                                `width` decimal(10,2) NOT NULL DEFAULT '0' COMMENT '宽(米)',
                                `height` decimal(10,2) NOT NULL DEFAULT '0' COMMENT '高(米)',
                                `cube` decimal(10,2)  NOT NULL DEFAULT '0' COMMENT '体积(立方米)',
                                `tare_weight` decimal(10,2)  NOT NULL DEFAULT '0' COMMENT '空箱自重(吨)',
                                `gross_weight` decimal(10,2)  NOT NULL DEFAULT '0' COMMENT '毛重(吨)',
                                `max_payload` decimal(10,2) NOT NULL DEFAULT '0' COMMENT '最大载重(吨)',
                                `status` tinyint(3) NOT NULL DEFAULT '0' COMMENT '0 可用, 1 禁用, 2 系统默认',
                                `add_time` datetime DEFAULT NULL COMMENT '创建时间',
                                `update_time` datetime DEFAULT NULL COMMENT '更新时间',
                                `deleted` tinyint(1) DEFAULT '0' COMMENT '逻辑删除',
                                PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COMMENT='标准集装箱表';

DROP TABLE IF EXISTS `litemall_file`;
CREATE TABLE `litemall_file` (
                                 `id` int(11) NOT NULL AUTO_INCREMENT,
                                 `user_id` int(11) NOT NULL  COMMENT '用户id',
                                 `status` tinyint(3) NOT NULL DEFAULT '0' COMMENT '0 可用, 1 禁用, 2 系统默认',
                                 `add_time` datetime DEFAULT NULL COMMENT '创建时间',
                                 `update_time` datetime DEFAULT NULL COMMENT '更新时间',
                                 `deleted` tinyint(1) DEFAULT '0' COMMENT '逻辑删除',
                                 `packing_filename` varchar(255) NOT NULL DEFAULT '' COMMENT '装箱文件名称',
                                 `packing_file` text NOT NULL DEFAULT '' COMMENT '装箱文件',
                                 `cube` decimal(10,2)  NOT NULL DEFAULT '0' COMMENT '总体积(立方米)',
                                 `weight` decimal(10,2)  NOT NULL DEFAULT '0' COMMENT '总重(Kg)',
                                 `quanlity` int(11) NOT NULL  COMMENT '总件数',
                                 `rowcount` int(11) NOT NULL  COMMENT '行数',
                                 PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COMMENT='装箱文件';

DROP TABLE IF EXISTS `litemall_file_detail`;
CREATE TABLE `litemall_file_detail` (
                                        `id` int(11) NOT NULL AUTO_INCREMENT,
                                        `file_id` int(11) NOT NULL  COMMENT '文件_id',
                                        ...
                                        `cube` decimal(10,2)  NOT NULL DEFAULT '0' COMMENT '体积(立方米)',
                                        PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COMMENT='装箱原文件产品';

DROP TABLE IF EXISTS `litemall_packing`;
CREATE TABLE `litemall_packing` (
                                    `id` int(11) NOT NULL AUTO_INCREMENT,
                                    `file_detail_id` int(11) NOT NULL COMMENT '产品id',
                                    `name` varchar(255) NOT NULL DEFAULT '' COMMENT '产品名称',
                                    `quantity` decimal(10,2) NOT NULL DEFAULT '0' COMMENT '数量',
                                    `length` decimal(10,2) NOT NULL DEFAULT '0' COMMENT '长(米)',
                                    `width` decimal(10,2) NOT NULL DEFAULT '0' COMMENT '宽(米)',
                                    ...
                                    `deleted` tinyint(1) DEFAULT '0' COMMENT '逻辑删除',
                                    PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COMMENT='装箱文件内容';


DROP TABLE IF EXISTS `litemall_packing_tactics`;
CREATE TABLE `litemall_packing_tactics` (
                                            `id` int(11) NOT NULL AUTO_INCREMENT,
                                            `file_id` int(11) NOT NULL  COMMENT '文件id',
                                            `width_priority` tinyint(1) DEFAULT '0' COMMENT '宽大优先',
                                            `length_priority`  tinyint(1) DEFAULT '0' COMMENT '长大优先',
                                            `quantity_priority`  tinyint(1) DEFAULT '0' COMMENT '数量优先',
                                            `cube_priority`  tinyint(1) DEFAULT '0' COMMENT '体积优先',
                                            `depth_search`  tinyint(1) DEFAULT '0' COMMENT '工作面深度搜索',
                                            `Shallowness_search`  tinyint(1) DEFAULT '0' COMMENT '工作面浅度搜索',
                                            `free_space_search`  tinyint(1) DEFAULT '0' COMMENT '剩余空间搜索 0深度搜索 1浅度搜索',
                                            `add_time` datetime DEFAULT NULL COMMENT '创建时间',
                                            `update_time` datetime DEFAULT NULL COMMENT '更新时间',
                                            `deleted` tinyint(1) DEFAULT '0' COMMENT '逻辑删除',
                                            PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COMMENT='装箱策略';

DROP TABLE IF EXISTS `litemall_packing_select`;
CREATE TABLE `litemall_packing_select` (
                                           `id` int(11) NOT NULL AUTO_INCREMENT,
                                           `file_id` int(11) NOT NULL  COMMENT '文件id',
                                           `file_tactics` int(11) NOT NULL  COMMENT '策略id',
                                           `detail` varchar(255) NOT NULL DEFAULT '' COMMENT '内容',
                                           `add_time` datetime DEFAULT NULL COMMENT '创建时间',
                                           `update_time` datetime DEFAULT NULL COMMENT '更新时间',
                                           `deleted` tinyint(1) DEFAULT '0' COMMENT '逻辑删除',
                                           PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COMMENT='装箱摆放细节';

DROP TABLE IF EXISTS `litemall_xmcatalog`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `litemall_xmcatalog` (
                                      `id` int(11) NOT NULL AUTO_INCREMENT,
                                      `name` varchar(63) NOT NULL DEFAULT '' COMMENT '类目名称',
                                      `keywords` varchar(1023) NOT NULL DEFAULT '' COMMENT '类目关键字，以JSON数组格式',
                                      `desc` varchar(255) DEFAULT '' COMMENT '类目广告语介绍',
                                      ...
                                      `deleted` tinyint(1) DEFAULT '0' COMMENT '逻辑删除',
                                      PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1036007 DEFAULT CHARSET=utf8mb4 COMMENT='知识库类目表';
/*!40101 SET character_set_client = @saved_cs_client */;

DROP TABLE IF EXISTS `litemall_knowledge`;
CREATE TABLE `litemall_knowledge` (
                                      `id` int(11) NOT NULL AUTO_INCREMENT,
                                      `title` varchar(255) NOT NULL DEFAULT '''' COMMENT '知识标题',
                                      `knowledge_catalog_id` int(11) DEFAULT '0' COMMENT '知识所属类目ID',
                                      `content` text COMMENT '知识内容，富文本格式',
                                      `read_count` varchar(255) DEFAULT '1k' COMMENT '知识阅读量',
                                      `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0 发布, 1 未发布',
                                      `lang` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0 中文, 1 英语',
                                      `is_popular` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0 常用, 1 不常用',
                                      `likes` int(11) NOT NULL DEFAULT '0' COMMENT '点赞次数',
                                      `unlikes` int(11) NOT NULL DEFAULT '0' COMMENT '吐槽次数',
                                      `sort_order` int(11) DEFAULT '100' COMMENT '排序',
                                      `add_time` datetime DEFAULT NULL COMMENT '创建时间',
                                      `update_time` datetime DEFAULT NULL COMMENT '更新时间',
                                      `deleted` tinyint(1) DEFAULT '0' COMMENT '逻辑删除',
                                      PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COMMENT='知识库';

DROP TABLE IF EXISTS `litemall_like`;
CREATE TABLE `litemall_like`  (
                                  `id` int(11) NOT NULL AUTO_INCREMENT,
                                  `type` tinyint(1) NULL DEFAULT NULL COMMENT '0：帖子，1评论，2：回复',
                                  `type_id` int NULL DEFAULT NULL COMMENT '点赞类型id',
                                  `status` tinyint(1) NULL DEFAULT NULL,
                                  `userid` int(11) NULL DEFAULT NULL,
                                  `user_xmid` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
                                  `like_time` timestamp(0) NULL DEFAULT NULL,
                                  PRIMARY KEY (`id`)
) ENGINE = InnoDB AUTO_INCREMENT = 10101 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic  COMMENT='点赞表';

SET FOREIGN_KEY_CHECKS = 1;

/*!40101 SET character_set_client = utf8 */;
DROP TABLE IF EXISTS `litemall_xmfeedback`;

CREATE TABLE `litemall_xmfeedback` (
                                       `id` int(11) NOT NULL AUTO_INCREMENT,
                                       `user_id` int(11) NOT NULL DEFAULT '0' COMMENT '用户表的用户ID',
                                       `username` varchar(63) NOT NULL DEFAULT '' COMMENT '用户名称',
                                       `mobile` varchar(20) NOT NULL DEFAULT '' COMMENT '手机号',
...
CREATE TABLE `litemall_admin` (
                                  ...
                                  `nickname` varchar(63)  DEFAULT '' COMMENT '用户简称',
                                  `capacity` varchar(63)  DEFAULT '' COMMENT '身份',
                                  `jobNumber` varchar(20)  DEFAULT '' COMMENT '用户工号',
                                  `dept` varchar(63)  DEFAULT '' COMMENT '部门',
                                  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1846 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='管理员表';

DROP TABLE IF EXISTS `litemall_approve_info`;

CREATE TABLE `litemall_approve_info` (
                                         `id` int(11) NOT NULL AUTO_INCREMENT,
                                         `bill_code` int(11) NOT NULL COMMENT '表单表名',
                                         `bill_name` varchar(63) NOT NULL COMMENT '表单名称',
                                         `bill_id` int(11) NOT NULL DEFAULT 0 COMMENT '单据id',
                                         `child_id` int(11) NOT NULL DEFAULT 0 COMMENT '子表id',
                                         `action` varchar(63) NOT NULL DEFAULT '' COMMENT '动作',
                                         `admin_id` int(11) NOT NULL COMMENT '操作员id',
                                         `note` varchar(200) DEFAULT NULL COMMENT '审批备注',
                                         `receiver` int(11) NOT NULL DEFAULT 0 COMMENT '下一步接收人',
                                         `next_action` varchar(63) NOT NULL DEFAULT '' COMMENT '下个动作',
                                         `require_id` varchar(63) NOT NULL DEFAULT '' COMMENT '钉钉请求id',
                                         `record_id` varchar(63) NOT NULL DEFAULT ''  COMMENT '待办事项id',
                                         `add_time` datetime DEFAULT NULL COMMENT '创建时间',
                                         `update_time` datetime DEFAULT NULL COMMENT '更新时间',
                                         `deleted` tinyint(1) DEFAULT '0' COMMENT '逻辑删除',
                                         PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COMMENT='审批操作信息';

DROP TABLE IF EXISTS `litemall_quote_model`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `litemall_quote_model` (
                                        `id` int(11) NOT NULL AUTO_INCREMENT,
                                        `name` varchar(63) NOT NULL COMMENT '模板名称',
                                        `version` varchar(63) NOT NULL DEFAULT '0.00'  COMMENT '模板版本号',
                                        `excel` varchar(163) NOT NULL DEFAULT '' COMMENT 'excel源文件',
                                        `duty` int(11) NOT NULL DEFAULT '0' COMMENT '核价负责人',
                                        `code` varchar(255) DEFAULT NULL COMMENT '默认供应商',
                                        `ceo_code` int(11) NOT NULL DEFAULT '0' COMMENT '终审负责人',
                                        `approve_code` varchar(255) DEFAULT NULL COMMENT '核价小组',
                                        `notice` varchar(255) DEFAULT NULL COMMENT '通知人员',
                                        `appendix` text  COMMENT '附件内容，富文本格式',
                                        `status` smallint(6) NOT NULL DEFAULT '0' COMMENT '0 可用, 1 禁用',
                                        `creator` int(11) DEFAULT NULL COMMENT '创建人',
                                        `modify` int(11) DEFAULT NULL COMMENT '更新人',
                                        `add_time` datetime DEFAULT NULL COMMENT '创建时间',
                                        `update_time` datetime DEFAULT NULL COMMENT '更新时间',
                                        `deleted` tinyint(1) DEFAULT '0' COMMENT '逻辑删除',
                                        PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COMMENT='询价单模板';

DROP TABLE IF EXISTS `litemall_quote_bill`;

CREATE TABLE `litemall_quote_bill` (   `id` int(11) NOT NULL AUTO_INCREMENT,
                                       `admin_id` int(11) NOT NULL COMMENT '询价人id',
                                       `purchaser` varchar(63) DEFAULT NULL COMMENT '询价人',
                                       `quote_model_excel` VARCHAR(255) DEFAULT NULL COMMENT 'excel源文件',
                                       `quote_end_date` datetime DEFAULT NULL COMMENT '报价截止日期',
                                       `quote_supply_code` varchar(255) DEFAULT NULL COMMENT '供应商钉钉Id',
                                       `quote_supply_name` varchar(255)  DEFAULT NULL COMMENT '供应商名称',
                                       `approve_code` varchar(255) DEFAULT NULL COMMENT '核价小组人',
                                       `duty_code` int(11) DEFAULT NULL COMMENT '负责人',
                                       `ceo_code` int(11) DEFAULT NULL COMMENT '终审人',
                                       `notice` varchar(255) DEFAULT NULL COMMENT '通知人员',
                                       `is_ceo` tinyint(1) DEFAULT '0' COMMENT '是否会签 否则直接通知CEO终审',
                                       `is_reApprove` tinyint(1) DEFAULT '0' COMMENT '是否会签 否则直接通知CEO终审',
                                       `duty_choice` varchar(63) DEFAULT NULL  COMMENT '负责人选择的中标厂家',
                                       `ceo_choice` varchar(63) DEFAULT NULL  COMMENT 'ceo选择的中标厂家',
                                       `purchaser_note` varchar(255) DEFAULT NULL COMMENT '询价要求',
                                       `notice_code` varchar(255) DEFAULT NULL COMMENT '终审通知人员',
                                       `model_name` int(11) DEFAULT NULL COMMENT '模板名称',
                                       `submit_date` datetime DEFAULT NULL COMMENT '提交时间',
                                       `dead_date` datetime DEFAULT NULL COMMENT '截止时间',
                                       `status` smallint(6) NOT NULL DEFAULT '0' COMMENT '0 制单, 1 提交, 2 审批中, 3 报价中, 3 投票中, 4 结案, 5 重新提交, 9 作废',
                                       `add_time` datetime DEFAULT NULL COMMENT '创建时间',
                                       `update_time` datetime DEFAULT NULL COMMENT '更新时间',
                                       `deleted` tinyint(1) DEFAULT '0' COMMENT '逻辑删除',
                                       PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COMMENT='询价单';
DROP TABLE IF EXISTS `litemall_quote_detail`;

CREATE TABLE `litemall_quote_electronic` (
                                         `id` int(11) NOT NULL AUTO_INCREMENT,
                                         `quote_id` int(11) DEFAULT NULL COMMENT '报价单主表ID',
                                         `code` varchar(63) DEFAULT NULL COMMENT '品号',
                                         `name` varchar(100) DEFAULT NULL COMMENT '品名',
                                         `spec` varchar(100) DEFAULT '' COMMENT '规格',
                                         `quantity_year` varchar(100) DEFAULT NULL COMMENT '年预估量',
                                         `price` decimal(10,2) NOT NULL DEFAULT '0' COMMENT '含税价',
                                         `delivery` varchar(63) DEFAULT NULL COMMENT '交期',
                                         `moq` varchar(63) DEFAULT '' COMMENT 'MOQ',
                                         `mpq` varchar(63)  DEFAULT NULL COMMENT 'MPQ',
                                         `package_size` varchar(63) DEFAULT '' COMMENT '包装方式',
                                         `brand` varchar(63)  DEFAULT NULL COMMENT '品牌',
                                         `certificate` varchar(100) DEFAULT ''COMMENT '证书情况 ',
                                         `status` smallint(6) NOT NULL DEFAULT '0' COMMENT '0 中标, 1 未中标, 2 等待结果, 3 询价单',
                                         `appendix` text  COMMENT '附件内容，富文本格式',
                                         `note` varchar(255) DEFAULT NULL COMMENT '备注',
                                         `add_time` datetime DEFAULT NULL COMMENT '创建时间',
                                         `update_time` datetime DEFAULT NULL COMMENT '更新时间',
                                         `deleted` tinyint(1) DEFAULT '0' COMMENT '逻辑删除',
                                         `bill_id` tinyint(1) DEFAULT '0' COMMENT '报价单还是询价单',
                                         `is_duty` tinyint(1) DEFAULT '0' COMMENT '责任人选择',
                                         `is_ceo` tinyint(1) DEFAULT '0' COMMENT 'ceo选择',
                                         `is_recheck` tinyint(1) DEFAULT '0' COMMENT '重新提交',
                                         PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COMMENT='电子电器类';

CREATE TABLE `litemall_quote_rubber` (
                                         `id` int(11) NOT NULL AUTO_INCREMENT,
                                         `quote_id` int(11) DEFAULT NULL COMMENT '报价单主表ID',
                                         `code` varchar(63) DEFAULT NULL COMMENT '品号',
                                         `name` varchar(100) DEFAULT NULL COMMENT '品名',
                                         `spec` varchar(100) DEFAULT '' COMMENT '规格',
                                         `weight` decimal(10,2) NOT NULL DEFAULT '0' COMMENT '理论重量',
                                         `material` varchar(63) DEFAULT NULL COMMENT '材质',
                                         `quantity_year` varchar(100) DEFAULT NULL COMMENT '年预估量',
                                         `device_type` varchar(100) DEFAULT '' COMMENT '设备型号(注塑机)',
                                         `loose_core` varchar(63)  DEFAULT NULL COMMENT '抽芯数(一出几)',
                                         `material_price` decimal(10,2) NOT NULL DEFAULT '0' COMMENT '材料价(元/克)',
                                         `mold_number` int(11) DEFAULT NULL COMMENT '模穴数(一出几）',
                                         `processing_cost_single` decimal(10,2) NOT NULL DEFAULT '0' COMMENT '单个产品加工费(元/克)',
                                         `piece_weight` decimal(10,2) NOT NULL DEFAULT '0' COMMENT '单个产品克重价格(元/克)',
                                         `mould_charge` decimal(10,2) NOT NULL DEFAULT '0' COMMENT '模具费',
                                         `status` smallint(6) NOT NULL DEFAULT '0' COMMENT '0 中标, 1 未中标, 2 等待结果, 3 询价单',
                                         `appendix` text  COMMENT '附件内容，富文本格式',
                                         `note` varchar(255) DEFAULT NULL COMMENT '备注',
                                         `add_time` datetime DEFAULT NULL COMMENT '创建时间',
                                         ...
                                         `is_recheck` tinyint(1) DEFAULT '0' COMMENT '重新提交',
                                         PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COMMENT='塑料橡胶类报价单子表';

CREATE TABLE `litemall_quote_die_casting` (
                                         `id` int(11) NOT NULL AUTO_INCREMENT,
                                         `quote_id` int(11) DEFAULT NULL COMMENT '报价单主表ID',
                                         `code` varchar(63) DEFAULT NULL COMMENT '品号',
                                         `name` varchar(100) DEFAULT NULL COMMENT '品名',
                                         `spec` varchar(100) DEFAULT '' COMMENT '规格',
                                         `size` varchar(63) DEFAULT NULL COMMENT '产品尺寸(长宽高)',
                                         `weight` decimal(10,2) NOT NULL DEFAULT '0' COMMENT '产品理论重量(克)',
                                         `quantity_year` varchar(100) DEFAULT NULL COMMENT '年预估量',
                                         `mold_number` int(11) DEFAULT NULL COMMENT '模穴数(一出几）',
                                         `cavity_material` varchar(63) DEFAULT NULL COMMENT '模腔材料',
                                         `loose_core` varchar(63)  DEFAULT NULL COMMENT '抽芯数(一出几)',
                                         `feeding_mode` varchar(63) DEFAULT NULL COMMENT '进料方式',
                                         `device_type` varchar(100) DEFAULT '' COMMENT '压铸机吨位',
                                         `deadline` varchar(63) DEFAULT NULL COMMENT '模具设计寿命',
                                         `mold_time` varchar(63) DEFAULT NULL COMMENT '开模时间',
                                         `mould_charge` decimal(10,2) NOT NULL DEFAULT '0' COMMENT '模具费(万)',
                                         `note1` varchar(255) DEFAULT NULL COMMENT '备注',
                                         `material`  varchar(63) DEFAULT NULL COMMENT '产品材料',
                                         `processing_charge` decimal(10,2) NOT NULL DEFAULT '0' COMMENT '产品加工费',
                                         `status` smallint(6) NOT NULL DEFAULT '0' COMMENT '0 中标, 1 未中标, 2 等待结果, 3 询价单',
                                         `appendix` text  COMMENT '附件内容，富文本格式',
                                         `note`  varchar(255) DEFAULT NULL COMMENT '备注',
                                         `add_time` datetime DEFAULT NULL COMMENT '创建时间',
                                         ...
                                         `is_recheck` tinyint(1) DEFAULT '0' COMMENT '重新提交',
                                         PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COMMENT='压铸模具类';

CREATE TABLE `litemall_quote_hardware` (
                                        `id` int(11) NOT NULL AUTO_INCREMENT,
                                        `quote_id` int(11) DEFAULT NULL COMMENT '报价单主表ID',
                                        `code` varchar(63) DEFAULT NULL COMMENT '品号',
                                        `name` varchar(100) DEFAULT NULL COMMENT '品名',
                                        ...
                                        `weight` decimal(10,2) NOT NULL DEFAULT '0' COMMENT '产品理论重量(克)',
                                        `quantity_year` varchar(100) DEFAULT NULL COMMENT '年预估量',
                                        `material_charge` decimal(10,2) NOT NULL DEFAULT '0' COMMENT '材料价格/吨',
                                        `material_per_charge` decimal(10,2) NOT NULL DEFAULT '0' COMMENT '单个产品材料价',
                                        `processing_charge` decimal(10,2) NOT NULL DEFAULT '0' COMMENT '加工费(剪板、冲压、攻牙等)',
                                        `electroplate_charge` decimal(10,2) NOT NULL DEFAULT '0' COMMENT '电镀费',
                                        `other_charge` decimal(10,2) NOT NULL DEFAULT '0'COMMENT '其它费用',
                                        `price` decimal(10,2) NOT NULL DEFAULT '0' COMMENT '产品报价',
                                        `status` smallint(6) NOT NULL DEFAULT '0' COMMENT '0 中标, 1 未中标, 2 等待结果, 3 询价单',
                                        `appendix` text  COMMENT '附件内容，富文本格式',
                                        `note`  varchar(255) DEFAULT NULL COMMENT '备注',
                                        `add_time` datetime DEFAULT NULL COMMENT '创建时间',
                                        ...
                                        `is_recheck` tinyint(1) DEFAULT '0' COMMENT '重新提交',
                                        PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COMMENT='五金类';

-- CREATE TABLE `litemall_quote_mould` (
--                                               `id` int(11) NOT NULL AUTO_INCREMENT,
--                                               `quote_id` int(11) DEFAULT NULL COMMENT '报价单主表ID',
--                                               `code` varchar(63) DEFAULT NULL COMMENT '品号',
--                                               `name` varchar(100) DEFAULT NULL COMMENT '品名',
--                                               `spec` varchar(100) DEFAULT '' COMMENT '规格',
--                                               `molding_cycle` varchar(63) DEFAULT NULL COMMENT '制模周期',
--                                               `die_life` varchar(63) DEFAULT NULL COMMENT '模具寿命',
--                                               `design_tonnage` varchar(63) DEFAULT NULL COMMENT '设计吨位',
--                                               `mold_number` int(11) DEFAULT NULL COMMENT '模穴数(一出几）',
--                                               `loose_core` varchar(63)  DEFAULT NULL COMMENT '抽芯数(一出几)',
--                                               `material_charge` decimal(10,2) NOT NULL DEFAULT '0' COMMENT '材料费合计',
--                                               `processing_charge` decimal(10,2) NOT NULL DEFAULT '0' COMMENT '加工费合计',
--                                               `design_fee` decimal(10,2) NOT NULL DEFAULT '0' COMMENT '设计费',
--                                               `management_fee` decimal(10,2) NOT NULL DEFAULT '0' COMMENT '管理费',
--                                               `profit` decimal(10,2) NOT NULL DEFAULT '0' COMMENT '利润',
--                                               `total_management_fee` decimal(10,2) NOT NULL DEFAULT '0' COMMENT '管理费合计',
--                                               `tax_amount` decimal(10,2) NOT NULL DEFAULT '0' COMMENT '税额(13%)',
--                                               `total_price` decimal(10,2) NOT NULL DEFAULT '0' COMMENT '模具总价',
--                                               `final_quotation` decimal(10,2) NOT NULL DEFAULT '0' COMMENT '最终模具报价',
--                                               `status` smallint(6) NOT NULL DEFAULT '0' COMMENT '0 中标, 1 未中标, 2 等待结果',
--                                               `appendix` text  COMMENT '附件内容，富文本格式',
--                                               `note`  varchar(255) DEFAULT NULL COMMENT '备注',
--                                               `add_time` datetime DEFAULT NULL COMMENT '创建时间',
--                                               `update_time` datetime DEFAULT NULL COMMENT '更新时间',
--                                               `deleted` tinyint(1) DEFAULT '0' COMMENT '逻辑删除',
--                                               PRIMARY KEY (`id`)
-- ) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COMMENT='模具报价明细';

-- CREATE TABLE `litemall_quote_detail` (
--                                          `id` int(11) NOT NULL AUTO_INCREMENT,
--                                          `quote_id` int(11) DEFAULT NULL COMMENT '报价单主表ID',
--                                          `code` varchar(63) DEFAULT NULL COMMENT '品号',
--                                          `name` varchar(100) DEFAULT NULL COMMENT '品名',
--                                          `spec` varchar(100) DEFAULT '' COMMENT '规格',
--                                          `unit` varchar(63)  DEFAULT NULL COMMENT '单位',
--                                          `price` varchar(63) DEFAULT '' COMMENT '报价',
--                                          `note` text DEFAULT NULL COMMENT '甲方备注',
--                                          `add_time` datetime DEFAULT NULL COMMENT '创建时间',
--                                          `update_time` datetime DEFAULT NULL COMMENT '更新时间',
--                                          `deleted` tinyint(1) DEFAULT '0' COMMENT '逻辑删除',
--                                          PRIMARY KEY (`id`),
--                                          foreign key(quote_id) references litemall_quote(id)
-- ) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COMMENT='询价单子表';
-- CREATE TABLE `litemall_quote_supply` (
--                                          `id` int NOT NULL AUTO_INCREMENT,
--                                          `quote_id` int NOT NULL DEFAULT '0' COMMENT '询价单ID',
--                                          `admin_id` int NOT NULL DEFAULT '0' COMMENT '供应商ID',
--                                          `admin_name` varchar(255) NOT NULL COMMENT '供应商简称',
--                                          `brief` text DEFAULT NULL COMMENT '供应商概述',
--                                          `add_time` datetime DEFAULT NULL COMMENT '创建时间',
--                                          `update_time` datetime DEFAULT NULL COMMENT '更新时间',
--                                          `deleted` tinyint(1) DEFAULT '0' COMMENT '逻辑删除',
--                                          PRIMARY KEY (`id`),
...
--                                          foreign key(quote_id) references litemall_quote(id),
--                                          foreign key(admin_id) references litemall_admin(id)
-- ) ENGINE=InnoDB AUTO_INCREMENT=877 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='询价单供应商表';

DROP TABLE IF EXISTS `litemall_requote`;

CREATE TABLE `litemall_requote` (
                                    `id` int(11) NOT NULL AUTO_INCREMENT,
                                    `quote_id` int NOT NULL DEFAULT '0' COMMENT '询价单ID',
                                    `admin_id` int NOT NULL COMMENT '供应商编码',
                                    `admin_name` varchar(63) DEFAULT NULL COMMENT '供应商简称',
                                    `quote_date` datetime DEFAULT NULL COMMENT '甲方答复日期',
                                    `note` varchar(63) DEFAULT NULL COMMENT '简短备注',
                                    `requote_excel` varchar(63) DEFAULT NULL COMMENT '供应商投标文件',
                                    `status` smallint(6) NOT NULL DEFAULT '0' COMMENT '0 询价单, 1 签收, 3 过期,4 提交 5 中标 6 未中标',
                                    `quote_model_excel_supply` varchar(255) DEFAULT NULL COMMENT 'excel模板文件',
                                    `submit_date` datetime DEFAULT NULL COMMENT '提交时间',
                                    `dead_date` datetime DEFAULT NULL COMMENT '截止时间',
                                    `add_time` datetime DEFAULT NULL COMMENT '创建时间',
                                    `update_time` datetime DEFAULT NULL COMMENT '更新时间',
                                    `deleted` tinyint(1) DEFAULT '0' COMMENT '逻辑删除',
                                    PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COMMENT='供应商竞价表';

DROP TABLE IF EXISTS `litemall_quote_detail`;

-- CREATE TABLE `litemall_requote_detail` (
--                                            `id` int(11) NOT NULL AUTO_INCREMENT,
--                                            `quote_id` int(11) DEFAULT NULL COMMENT '报价单主表ID',
--                                            `code` varchar(63) DEFAULT NULL COMMENT '品号',
--                                            `name` varchar(100) DEFAULT NULL COMMENT '品名',
...
--                                            `unit` varchar(63)  DEFAULT NULL COMMENT '单位',
--                                            `price` varchar(63) NOT NULL DEFAULT '' COMMENT '报价',
--                                            `supply_note` text DEFAULT NULL COMMENT '备注',
--                                            `add_time` datetime DEFAULT NULL COMMENT '创建时间',
--                                            `update_time` datetime DEFAULT NULL COMMENT '更新时间',
--                                            `deleted` tinyint(1) DEFAULT '0' COMMENT '逻辑删除',
--                                            PRIMARY KEY (`id`),
--                                            foreign key(quote_id) references litemall_requote(id),
-- ) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COMMENT='供应商竞价子表';
/*!40101 SET character_set_client = @saved_cs_client */;
