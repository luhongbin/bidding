      ...
      <el-row :gutter="40" class="panel-group">
        <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
          <div class="card-panel" @click="handleSetLineChartData('newVisitis')">
            ...
            <div class="card-panel-description">
              <div class="card-panel-text">询价单数</div>
              <count-to :start-val="0" :end-val="purTotalCount" :duration="2600" class="card-panel-num" />
            </div>
          </div>
        </el-col>
        <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
          <div class="card-panel" @click="handleSetLineChartData('messages')">
            ...
            <div class="card-panel-description">
              <div class="card-panel-text">超时单数</div>
              <count-to :start-val="0" :end-val="mywaitTotalCount" :duration="3000" class="card-panel-num" />
            </div>
          </div>
        </el-col>
        <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
          <div class="card-panel" @click="handleSetLineChartData('purchases')">
            ...
            <div class="card-panel-description">
              <div class="card-panel-text">审批中单</div>
        ...
        <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
          <div class="card-panel" @click="handleSetLineChartData('shoppings')">
            ...
            <div class="card-panel-description">
              <div class="card-panel-text">中标单数</div>
              <count-to :start-val="0" :end-val="purOverCount" :duration="3600" class="card-panel-num" />
            </div>
          </div>
        </el-col>
      </el-row>
...
export default {
  ...
  methods: {
    ...
    init() {
      ...
      quote().then(response => {
        this.purTotalCount = response.data.data.value.purTotalCount
        this.mywaitTotalCount = response.data.data.value.mywaitTotalCount
    ...
    getYiYan() {
      getYiYan().then(res => { this.yiyan = res.data })
    }
  }
}
</script>
