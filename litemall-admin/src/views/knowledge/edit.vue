<template>
  <div class="app-container">
      ...
      <el-form ref="knowledge" :rules="rules" :model="knowledge" label-width="150px">
        ...
        <el-form-item label="是否常用" prop="isPopular">
          <el-radio-group v-model="knowledge.isPopular">
            ...
            <el-radio :label="false">不常用</el-radio>
          </el-radio-group>
        </el-form-item>
    ...
    <div class="op-container">
      ...
      <el-button type="primary" @click="handleEdit">更新知识库</el-button>
    </div>
...
<script>
import { detailKnowledge, editKnowledge, listCatAndBrand } from '@/api/knowledge'
...
export default {
  ...
  methods: {
    init: function() {
      ...
      detailKnowledge(id).then(response => {
        this.knowledge = response.data.data.knowledge
