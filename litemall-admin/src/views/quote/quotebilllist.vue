<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <el-button v-permission="['GET /admin/quoteBill/listBrowser']" class="filter-item" type="primary" icon="el-icon-search" @click="handleFilter">查询</el-button>
      <el-button v-permission="['GET /admin/quoteBill/listBrowserCeo']" class="filter-item" type="primary" icon="el-icon-search" @click="getListCeo">全部查询</el-button>
    ...
    <el-card v-show="rubberCardVisiable" class="box-card">
      ...
      <el-table v-loading="listLoading" :data="quoteRubberslist" element-loading-text="正在查询中。。。" border fit highlight-current-row>
        ...
        <el-table-column align="center" label="询价单状态" prop="quoteStatusFilter">
          <template slot-scope="scope">
            <el-tag>{{ scope.row.quoteBillstatus | quoteStatusFilter }}</el-tag>
          </template>
        </el-table-column>
