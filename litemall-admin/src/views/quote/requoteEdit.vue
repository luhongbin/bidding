    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      <el-card class="box-card">
        ...
        <el-form ref="quote" :model="quote" status-icon label-position="left" label-width="100px">
          ...
          <el-form-item label="单据">
            <span>(类型) {{ formatModel(quote.modelName) }}</span>
            <el-button v-if="quote.quoteModelExcel !== '' && quote.quoteModelExcel !== null" size="mini" type="info" icon="el-icon-download" plain @click="openExcel(quote.quoteModelExcel,'报价ID' + quote.id.toString()+'.xlsx')">下载</el-button>
          </el-form-item>
          <el-form-item label="询价概要">
            <span>{{ quote.purchaserNote }}</span>
          </el-form-item>
