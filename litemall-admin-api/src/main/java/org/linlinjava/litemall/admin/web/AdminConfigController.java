...
public class AdminConfigController {
    ...
    @RequiresPermissions("admin:config:quote:list")
    @RequiresPermissionsDesc(menu = {"配置管理", "询价单配置"}, button = "详情")
    @GetMapping("/quote")
    public Object listQuote() {
        Map<String, String> data = systemConfigService.listQuote();
        return ResponseUtil.ok(data);
    }

    @RequiresPermissions("admin:config:quote:updateConfigs")
    @RequiresPermissionsDesc(menu = {"配置管理", "询价单配置"}, button = "编辑")
    @PostMapping("/quote")
    public Object updatequote(@RequestBody String body) {
