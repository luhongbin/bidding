...
import org.linlinjava.litemall.admin.dto.OrderGoodsinone;
...
public class AdminOrderController {
     ...
     * 编辑单价
     *
     * @param OrderGoodsinone
     * @return
     */
    @RequiresPermissions("admin:order:setPrice")
    @RequiresPermissionsDesc(menu = {"商场管理", "订单管理"}, button = "设置价格")
    @PostMapping("/setPrice")
    public Object setprice(@RequestBody OrderGoodsinone OrderGoodsinone) {
        return adminOrderService.setPrice(OrderGoodsinone);
    }
